...
public class Main {
    ...
    public static void employeeLogin(String username, String password) {
        ...
        Integer id = employeeService.login(employee1);
        if (id != 0) {
            employeeMenu(id);
    ...
    public static void profLogin(String username, String password) {
        ...
        Integer id = profService.login(prof);
        if (id != 0) {
            profMenu(id);
                ...
                switch (operator) {
                    ...
                    case 2:
                        ...
                        for (Course course : courses
                            ...
                            System.out.println("id:" + course.getId() + " course name:" + course.getName() + " prof id:" + course.getProf().getId() + " :year" +
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        List<Integer> courseIds = courseStudentService.courseByStudentId(Id);
    ...
    public static void profCreating() {
        ...
        try {
            ...
            prof.setPassword(password);
            if (operator == 1) {
                prof.setType("hagholtadris");
            } else {
                prof.setType("heyatelmi");
            }
            int id = profService.create(prof);
            if (id > 0) {
                System.out.println("done!");
            }
        } catch (InputMismatchException e) {
        ...
        while (flag) {
            ...
            try {
                ...
                if (prof != null) {
                    ...
                    switch (operator) {
                        case 1:
                            prof.setFirstname(newValue);
                            profService.Update(prof);
                            break;
                        case 2:
                            prof.setLastname(newValue);
                            profService.Update(prof);
                            break;
                        case 3:
                            prof.setUsername(newValue);
                            profService.Update(prof);
                            break;
                        case 4:
                            prof.setPassword(newValue);
                            profService.Update(prof);
                            break;
                        case 5:
                        case 6:
                ...
                if (student != null) {
                    ...
                    switch (operator) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            student.setUsername(newValue);
                            studentService.Update(student);
                            break;
                        case 4:
                            student.setPassword(newValue);
                            studentService.Update(student);
                            break;
                        case 5:
                            flag = false;
                    ...
                    switch (operator) {
                        ...
                        case 2:
                            ...
                            if (prof != null) {
                                ...
                                System.out.println("there is no prof with this id!");
                                break;
                            }
    ...
    public static void submittingScore(Integer id) {
        ...
        for (Course course : courses
            ...
            if (Objects.equals(course.getProf().getId(), id)) {
                System.out.println("id:" + course.getId() + " course name:" + course.getName() + " prof id:" + course.getProf().getId() + " :year" +
                        course.getYear() + " term:" + course.getTerm() +
                        " unit:" + course.getUnit());
            }
    ...
    public static void showingPayment(Integer id) {
        try {
            ...
            for (Course course : courses
                ...
                if (Objects.equals(course.getProf().getId(), id) && Objects.equals(course.getYear(), yearOfCourse) && Objects.equals(course.getTerm(), term)) {
    ...
    public static void unitSelecting(Integer id) {
        try {
            ...
            while (flag) {
                ...
                switch (operator) {
                    case 1:
                        addingUnit(yearOfCourse, term, id);
                        break;
                    case 2:
                        deletingUnit(yearOfCourse, term, id);
                        break;
                    case 3:
                        flag = false;
                        break;
    ...
    public static void addingUnit(Integer year, Integer term, Integer id) {
        ...
        if (unitCounter > 0) {
            lastTermAvg = scoreCounter / unitCounter;
        }
        unitCounter = 0;
        ...
        try {
            ...
            if (lastTermAvg > 18) {
                if (unitCounter + course.getUnit() > 24) {
                    ...
                    courseStudentService.unitSelecting(student, course);
                    return;
                }
